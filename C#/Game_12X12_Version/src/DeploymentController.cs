...
{
	public static int SHIPS_TOP = 98;
	private const int SHIPS_LEFT = 20;
	public static  int SHIPS_HEIGHT = 90;
	...
	private static void DoDeployClick()
	{
		...
		int row = 0;
		int col = 0;
		row = Convert.ToInt32(Math.Floor((mouse.Y) / (UtilityFunctions.CELL_HEIGHT_DEPLOY + UtilityFunctions.CELL_GAP))) - 3;
