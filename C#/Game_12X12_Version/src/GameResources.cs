...
public static class GameResources
{
	...
	private static void LoadImages()
	{
        ...
        if (GameController.LoadTileOption() == 10)
        {
            NewImage("Discovery", "discover_10X10.jpg");
            NewImage("Deploy", "deploy_10X10.jpg");
            NewImage("SelectedShip", "deploy_button_hl_10X10.png");
        }
        else
        {
            NewImage("Discovery", "discover_12X12.jpg");
            NewImage("Deploy", "deploy_12X12.jpg");
            NewImage("SelectedShip", "deploy_button_hl_12X12.png");
        }
