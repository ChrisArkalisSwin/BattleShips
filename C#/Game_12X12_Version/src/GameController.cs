...
{
    public static int _TileSetting;
    ...
    public static void SetTile(int setting)
    {
        _TileSetting = setting;
    }

    public static int LoadTileOption()
    {
        string filename = null;
        filename = SwinGame.PathToResource("TileOption.txt");
        ...
        //Read in tile option
        int num = 0;
        num = Convert.ToInt32(input.ReadLine());
    ...
    public static void SaveTileOption(int num)
    {
        string filename = null;
        filename = SwinGame.PathToResource("TileOption.txt");
    ...
    public static void ChangeTileSize(int num)
    {
        if (num == 10)
        {
            UtilityFunctions.FIELD_TOP = 122;
            UtilityFunctions.FIELD_LEFT = 349;
            UtilityFunctions.FIELD_WIDTH = 418;
            UtilityFunctions.FIELD_HEIGHT = 418;
            UtilityFunctions.MESSAGE_TOP = 548;
            UtilityFunctions.CELL_WIDTH = 40;
            UtilityFunctions.CELL_HEIGHT = 40;
            UtilityFunctions.CELL_GAP = 2;
            UtilityFunctions.SHIP_GAP = 3;

            UtilityFunctions.CELL_GAP_DEPLOY = 2;
            UtilityFunctions.CELL_HEIGHT_DEPLOY = 40;

            DeploymentController.SHIPS_TOP = 98;
            DeploymentController.SHIPS_HEIGHT = 90;
        }
        else
        {
            UtilityFunctions.FIELD_TOP = 124;
            UtilityFunctions.FIELD_LEFT = 329;
            UtilityFunctions.FIELD_WIDTH = 420;
            UtilityFunctions.FIELD_HEIGHT = 418;
            UtilityFunctions.MESSAGE_TOP = 548;
            UtilityFunctions.CELL_WIDTH = 35;
            UtilityFunctions.CELL_HEIGHT = 35;
            UtilityFunctions.CELL_GAP = 2;
            UtilityFunctions.SHIP_GAP = 2;

            UtilityFunctions.CELL_GAP_DEPLOY = 2;
            UtilityFunctions.CELL_HEIGHT_DEPLOY = 36;

            DeploymentController.SHIPS_TOP = 100;
            DeploymentController.SHIPS_HEIGHT = 80;
        }
    }
}