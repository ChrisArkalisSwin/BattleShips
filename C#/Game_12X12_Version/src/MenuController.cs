...
static class MenuController
{
    ...
    private const int SETUP_MENU_10X10_BUTTON = 3;
    private const int SETUP_MENU_12X12_BUTTON = 4;
	...
	private static void PerformMainMenuAction(int button)
	{
		switch (button) {
			case MAIN_MENU_PLAY_BUTTON:
                GameController.ChangeTileSize(GameController._TileSetting);
	...
	private static void PerformSetupMenuAction(int button)
	{
		switch (button) {
			...
			case SETUP_MENU_HARD_BUTTON:
				...
				break;
            case SETUP_MENU_10X10_BUTTON:
                GameController.SaveTileOption(10);
                GameResources.FreeResources();
                GameResources.LoadResources();
                break;
            case SETUP_MENU_12X12_BUTTON:
                GameController.SaveTileOption(12);
                GameResources.FreeResources();
                GameResources.LoadResources();
